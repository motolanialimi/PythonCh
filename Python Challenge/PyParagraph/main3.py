...
#sets file
file = os.path.join('PyParagraph', 'PyParagraph Raw data', 'paragraph_' + str(file_num) + '.txt')
...
#sets output file 
output_file = os.path.join('PyParagraph', 'PyParagraph Output', 'paragraph_analysis_' + str(file_num)+ '.txt')
