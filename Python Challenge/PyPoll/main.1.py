...
file = os.path.join('PyPoll', 'PyPoll Raw data', 'election_data_' + str(file_num) + '.csv')
...
#prints to file
output_file = os.path.join('PyPoll', 'PyPoll Output', 'election_results_' + str(file_num) +'.txt')
